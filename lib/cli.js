...
function runOe(env, commandArgs) {
  ...
  router.registerRoute('studio', require('./routes/studio'));
  ...
  }else if (commandArgs && commandArgs[0] === "studio") {
    router.navigate("studio", commandArgs);
  } else {
