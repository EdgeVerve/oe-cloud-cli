...
module.exports = app => {
  ...
  const defaultChoices = [
    {
      ...
      value: {
        method: 'studio:defaultUI',
        type: 'studio:defaultUI'
      }
    }, {
      name: 'Generate UIRoute',
      value: {
        method: 'studio:createRoute',
        type: 'studio:createRoute'
      }
    }, {
      name: 'Generate Navigation Link',
      value: {
        method: 'studio:createNavigation',
        type: 'studio:createNavigation'
      }
    }, {
      name: 'Attach workflow to model',
      value: {
        method: 'studio:attachWorkflow',
        type: 'studio:attachWorkflow'
      }
    }, {
      name: 'Attach rule to model',
      value: {
        method: 'studio:attachRules',
        type: 'studio:attachRules'
      }
    }, {
  ...
  return fullname().then(name => {
    ...
    return inquirer.prompt([{
      ...
      if (answer.whatNext.method === 'studio:defaultUI') {
        app.navigate('studio:defaultUI', answer.whatNext.type);
        return;
      }

      switch (answer.whatNext.method) {
        case 'studio:defaultUI':
        case 'studio:createRoute':
        case 'studio:createNavigation':
        case 'studio:attachWorkflow':
        case 'studio:attachRules':app.navigate(answer.whatNext.type, answer.whatNext.type);
          return;
          break;
        default:
          break;
