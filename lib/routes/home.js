  ...
  const defaultChoices = [
    {
      ...
      value: {
        method: 'studio:default-ui',
        type: ['studio','default-ui']
      }
    }, {
      name: 'Generate UIRoute',
      value: {
        method: 'studio:create-route',
        type: ['studio','create-route']
      }
    }, {
      name: 'Generate Navigation Link',
      value: {
        method: 'studio:create-navigation',
        type: ['studio','create-navigation']
      }
    }, {
      name: 'Attach workflow to model',
      value: {
        method: 'studio:attach-workflow',
        type: ['studio','attach-workflow']
      }
    }, {
      name: 'Attach rule to model',
      value: {
        method: 'studio:attach-rules',
        type: ['studio','attach-rules']
      }
    }, {
  ...
  return fullname().then(name => {
    ...
    return inquirer.prompt([{
      ...
      switch (answer.whatNext.method) {
        case 'studio:default-ui':
        case 'studio:create-route':
        case 'studio:create-navigation':
        case 'studio:attach-workflow':
        case 'studio:attach-rules':app.navigate('studio', answer.whatNext.type);
              return;
              break;
        default:
              break;
