  ...
  const defaultChoices = [
    {
      ...
      value: {
        method: 'generate:default-ui',
        type: ['generate','default-ui']
      }
    }, {
      name: 'Generate UIRoute',
      value: {
        method: 'generate:create-route',
        type: ['generate','create-route']
      }
    }, {
      name: 'Generate Navigation Link',
      value: {
        method: 'generate:create-navigation',
        type: ['generate','create-navigation']
      }
    }, {
      name: 'Attach workflow to model',
      value: {
        method: 'generate:attach-workflow',
        type: ['generate','attach-workflow']
      }
    }, {
      name: 'Attach rule to model',
      value: {
        method: 'generate:attach-rules',
        type: ['generate','attach-rules']
      }
    }, {
  ...
  return fullname().then(name => {
    ...
    return inquirer.prompt([{
      ...
      switch (answer.whatNext.method) {
        case 'generate:default-ui':
        case 'generate:create-route':
        case 'generate:create-navigation':
        case 'generate:attach-workflow':
        case 'generate:attach-rules':app.navigate('generate', answer.whatNext.type);
              return;
              break;
        default:
              break;
